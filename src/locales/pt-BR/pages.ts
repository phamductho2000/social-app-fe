export default {
  ...
  'pages.login.accountLogin.tab': 'Index da conta',
  'pages.login.accountLogin.errorMessage': 'usuário/senha incorreto(admin/ant.design)',
  'pages.login.failure': 'Index falhou, por favor tente novamente!',
  'pages.login.success': 'Index efetuado com sucesso!',
  ...
  'pages.login.phoneLogin.tab': 'Index com Telefone',
  ...
  'pages.login.loginWith': 'Index com :',
