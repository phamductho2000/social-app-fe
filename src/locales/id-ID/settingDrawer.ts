export default {
  ...
  'app.setting.fixedheader': 'Index Tetap',
  'app.setting.fixedsidebar': 'Sidebar Tetap',
  'app.setting.fixedsidebar.hint': 'Berjalan pada Susunan Menu Samping',
  'app.setting.hideheader': 'Sembunyikan Index ketika gulir ke bawah',
  'app.setting.hideheader.hint': 'Bekerja ketika Index tersembunyi dimunculkan',
